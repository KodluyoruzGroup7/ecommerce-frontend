...
const ProductDetailTabs = () => {
  return (
    <Tabs type='card' defaultActiveKey="detail">
      <TabPane tab="Product Details" key="detail" style={{ padding: "1rem 2rem" }}>
        <p>A little crisp, a little sunny, warm enough to skip a coat, just cool enough to wrap great cashmere around is this asymmetrical jumper. With a chic hue, this one makes for a perfect pick this fall. So get your basics right and you are good to go.</p>
        <ul>
      ...
      <TabPane tab="Shipping &amp; Returns" key="shippingreturns">
        <h3>Return Policy</h3>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sapiente illo ea nisi labore non facilis pariatur magnam voluptatem excepturi ex placeat eum, quo repellat tempora. Eligendi quod minus ullam in?</p>
